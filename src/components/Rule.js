    ...
    <div>
        <div className="rule-content">
            <div className="instruction">
                ...
                <p>There are three level of difficulties in this game. In easy mode, you  need to find a 5-letter random word with 7 tries. In medium mode, you need to find a 6-letter random word with 6 tries. In easy mode, you need to find a 7-letter random word with 5 tries. By clicking the reset button, you can start a new game.</p>
            </div>
            <hr/>
